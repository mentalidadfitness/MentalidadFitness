    ...
    <div class="container" style="position:absolute;z-index:0">
      <div class="row">
        <div class="col-xs-12 col-md-4 col-md-offset-4">
              ...
              <form class="" name="form" action="?c=user&a=sendEmailRecoverPassword" method="post" id="MF_formulario" data-parsley-validate>
                <!-- INPUT EMAIL -->
                <div class="form-group">
                  <input type="email" class="form-control" name="email" id="MF_inputemailred" required="" data-parsley-type placeholder="EMAIL">
