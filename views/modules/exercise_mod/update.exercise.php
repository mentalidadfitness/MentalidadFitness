    ...
    -->
  		<div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
  			<ul class="nav navbar-nav">
  				<li class=""><a href="#">INICIO<span style="font-size:16px;" class="pull-right hidden-xs showopacity glyphicon glyphicon-home"></span></a></li>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu forAnimate" role="menu">
              <li><a href="#">Gestionar Alimentos</a></li>
              <li><a href="#">Gestionar Desayunos</a></li>
              <li><a href="#">Gestionar Almuerzos</a></li>
              <li><a href="#">Gestionar Snacks</a></li>
              <li><a href="#">Gestionar Cenas</a></li>
