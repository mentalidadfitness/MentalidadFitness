...
<img  src="imagenes/1fit.png" style="width:100%" id="img2">
<img src="imagenes/triangulo.png" id="triangulo" style="width: 100%">
<form>
  ...
  <div class="form-group">
    <input type="password" class="form-control" placeholder="Contraseña" required="Este campo es obligatorio">
